# Comparing `tmp/mercurius-rest-0.0.2.tar.gz` & `tmp/mercurius-rest-0.0.3.tar.gz`
...
### Comparing `mercurius-rest-0.0.2/mercurius/rest/integration.py` & `mercurius-rest-0.0.3/mercurius/rest/integration.py`
