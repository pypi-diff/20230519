# Comparing `tmp/tencentcloud-sdk-python-redis-3.0.894.tar.gz` & `tmp/tencentcloud-sdk-python-redis-3.0.895.tar.gz`
...
## Comparing `tencentcloud-sdk-python-redis-3.0.894.tar` & `tencentcloud-sdk-python-redis-3.0.895.tar`
...
### Comparing `tencentcloud-sdk-python-redis-3.0.894/README.rst` & `tencentcloud-sdk-python-redis-3.0.895/README.rst`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.894/tencentcloud/redis/v20180412/redis_client.py` & `tencentcloud-sdk-python-redis-3.0.895/tencentcloud/redis/v20180412/redis_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.894/tencentcloud/redis/v20180412/errorcodes.py` & `tencentcloud-sdk-python-redis-3.0.895/tencentcloud/redis/v20180412/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.894/tencentcloud/redis/v20180412/models.py` & `tencentcloud-sdk-python-redis-3.0.895/tencentcloud/redis/v20180412/models.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.894/tencentcloud/__init__.py` & `tencentcloud-sdk-python-redis-3.0.895/tencentcloud/__init__.py`
...
### Comparing `tencentcloud-sdk-python-redis-3.0.894/PKG-INFO` & `tencentcloud-sdk-python-redis-3.0.895/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-redis-3.0.894/setup.py` & `tencentcloud-sdk-python-redis-3.0.895/setup.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.894/tencentcloud_sdk_python_redis.egg-info/PKG-INFO` & `tencentcloud-sdk-python-redis-3.0.895/tencentcloud_sdk_python_redis.egg-info/PKG-INFO`
